...
function actualizarContacto(id, actualizar) {
  const user = lista_Contacto.find(user => user.id === id);

  if (user) {
    console.log("Antes de actualizar:", user);
    Object.assign(user, actualizar);
    console.log("Después de actualizar:", user);
  } else {
    console.log(`No se encontró ninguna usuario con el id ${id}.`);
  }
  }
...
actualizarContacto(1702788010529,{
nombre:"Juan LUis",
edad:"24"
